...
import com.lwons.widget.hw.HwTextureView

class HwTextureViewRenderer @JvmOverloads constructor(ctx: Context, attrs: AttributeSet? = null, defStyle: Int = 0) :
    HwTextureView(ctx, attrs, defStyle), SurfaceTextureListener, IRenderer {
